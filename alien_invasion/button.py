...
class Button():
    def __init__(self, ai_settings, screen, msg): # Inicializa os atributos do botão
    ...
    def draw_button(self): # desenha um botão em branco e, em seguida, desenha a mensagem
